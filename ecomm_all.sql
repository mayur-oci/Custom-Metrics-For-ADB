...
BEGIN
  DBMS_SCHEDULER.CREATE_JOB (
   ...
   max_runs           =>   120,                        -- in production prefer end_date instead or skip it alltogether
   auto_drop          =>   FALSE,
...
WHERE OWNER='ECOMMERCE_USER' AND JOB_NAME LIKE2 'POPULATE%' OR JOB_NAME LIKE2 'POST_METRICS%' 
